...
router.put("/boards/postmodify/:board_uid",isAuthenticated, postCtrl.postmodify); // 게시글 수정
...
router.put("/boards/:board_uid/:comment_uid",isAuthenticated, commentCtrl.cmtmodify);// 댓글 수정
router.delete("/boards/:board_uid/:comment_uid",isAuthenticated, commentCtrl.cmtdel);// 댓글 삭제
